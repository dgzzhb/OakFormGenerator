...
<div class="demoHead" id = "non-print" >
  ...
  assets and investment experience</td>
          ...
          <tr>
            <td>How?</td>
            <td>All financial companies need to share customers’ personal information to run their everyday business. In the section below, we list the reasons financial companies can share their customers’ personal information; the reasons Bank of America chooses to share; and whether you can limit this sharing.</td>
          </tr>                
        </tbody>
      </table>    
    </div> <!-- facts -->
      ...
      <table class="table table-bordered">
        <thead>
          <tr>
            ...
            <th>Does Bank of America share?</th>
      ...
      <table class="table table-bordered">
        <tbody class="left-colored"> 
          <tr>
            ...
            <td>Call 888.341.5000 - our menu will prompt you through your choices
  ...
  If you are a new customer, we can begin sharing your information 45 days from the date we sent this notice. When you are no longer our customer, we continue to share your information as described in this notice. However, you can contact us at any time to limit our sharing.</td>
          ...
          <tr>
            <td>Why?</td>
            <td>Call 888.341.5000 or go to bankofamerica.com/privacy</td>
          </tr>           
        </tbody>
      </table>    
    </div> <!-- first-footer -->
    <div class="container" id="second-page">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            <td>How does Bank of America protect my personal information?</td>
          ...
          <tr>
            <td>How does Bank of America collect my personal information?</td>
  ...
  State laws and individual Bank of America companies may give you more rights to limit sharing. See Other important information section for your rights under state law.</td>
          </tr>
          <tr>
