      ...
      <table class="table table-bordered" id="optOut" style="display:none">
        <tbody class="left-colored"> 
          <tr>
            ...
            <td>
            <%
            HashSet<String> phoneHH = (HashSet<String>)session.getAttribute("phoneHH");
			 exist = (phoneHH!=null);
            %>
